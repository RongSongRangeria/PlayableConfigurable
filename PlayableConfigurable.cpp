...
/* en_GB */ {
    ...
    "Font not loaded - may show blanks"
},
/* ru_RU */ {
    ...
    "\xD0\xA8\xD1\x80\xD0\xB8\xD1\x84\xD1\x82" " " "\xD0\xBD\xD0\xB5" " " "\xD0\xB7\xD0\xB0\xD0\xB3\xD1\x80\xD1\x83\xD0\xB6\xD0\xB5\xD0\xBD" " - " "\xD0\xB2\xD0\xBE\xD0\xB7\xD0\xBC\xD0\xBE\xD0\xB6\xD0\xBD\xD1\x8B" " " "\xD0\xBF\xD1\x80\xD0\xBE\xD0\xBF\xD1\x83\xD1\x81\xD0\xBA\xD0\xB8"
},
/* es_ES */ {
    ...
    "Fuente no cargada - pueden aparecer espacios en blanco"
},
/* zh_CN */ {
    ...
    "\xE5\xAD\x97\xE4\xBD\x93\xE6\x9C\xAA\xE5\x8A\xA0\xE8\xBD\xBD" " - " "\xE5\x8F\xAF\xE8\x83\xBD\xE6\x98\xBE\xE7\xA4\xBA\xE7\xA9\xBA\xE7\x99\xBD\xE5\xAD\x97\xE7\xAC\xA6"
},
/* de_DE */ {
    ...
    "Schriftart nicht geladen - evtl. leere Zeichen"
},
/* fr_FR */ {
    ...
    "Police non charg" "\xC3\xA9" "e - caract" "\xC3\xA8" "res vides possibles"
},
/* ja_JP */ {
    ...
    "\xE3\x83\x95\xE3\x82\xA9\xE3\x83\xB3\xE3\x83\x88\xE6\x9C\xAA\xE8\xAA\xAD\xE3\x81\xBF\xE8\xBE\xBC\xE3\x81\xBF" " - " "\xE7\xA9\xBA\xE7\x99\xBD\xE3\x81\xAB\xE3\x81\xAA\xE3\x82\x8B\xE5\x8F\xAF\xE8\x83\xBD\xE6\x80\xA7"
},
/* ko_KR */ {
    ...
    "\xED\x8F\xB0\xED\x8A\xB8" " " "\xEB\xA1\x9C\xEB\x93\x9C" " " "\xEC\x95\x88" " " "\xEB\x90\xA8" " - " "\xEB\xB9\x88" " " "\xEB\xAC\xB8\xEC\x9E\x90\xEB\xA1\x9C" " " "\xED\x91\x9C\xEC\x8B\x9C\xEB\x90\xA0" " " "\xEC\x88\x98" " " "\xEC\x9E\x88\xEC\x9D\x8C"
},
/* pt_BR */ {
    ...
    "Fonte n" "\xC3\xA3" "o carregada - pode mostrar caracteres em branco"
},
/* uk_UA */ {
    ...
    "\xD0\xA8\xD1\x80\xD0\xB8\xD1\x84\xD1\x82" " " "\xD0\xBD\xD0\xB5" " " "\xD0\xB7\xD0\xB0\xD0\xB2\xD0\xB0\xD0\xBD\xD1\x82\xD0\xB0\xD0\xB6\xD0\xB5\xD0\xBD\xD0\xBE" " - " "\xD0\xBC\xD0\xBE\xD0\xB6\xD0\xBB\xD0\xB8\xD0\xB2\xD1\x96" " " "\xD0\xBF\xD1\x80\xD0\xBE\xD0\xBF\xD1\x83\xD1\x81\xD0\xBA\xD0\xB8"
},
/* pl_PL */ {
    ...
    "Czcionka nie za" "\xC5\x82" "adowana - mo" "\xC5\xBC" "liwe puste znaki"
},
/* zh_TW */ {
    ...
    "\xE5\xAD\x97\xE5\x9E\x8B\xE6\x9C\xAA\xE8\xBC\x89\xE5\x85\xA5" " - " "\xE5\x8F\xAF\xE8\x83\xBD\xE9\xA1\xAF\xE7\xA4\xBA\xE7\xA9\xBA\xE7\x99\xBD\xE5\xAD\x97\xE7\xAC\xA6"
}
};
...
void Draw()
{
    ...
    if (langWarn)
    {
        ...
        langWarn->setCaption(warn ? STR[g_autoLang][T_FONT_WARN] : "");
        langWarn->setVisible(warn);
    }
}
...
void OnFontWarnTip(WP s, const TT& info)
{
    TIP_GUARD(info)
    ShowTip("The selected language's font isn't loaded right now, so some of "
             "its text may show blank boxes instead of characters.", info);
}
...
void BuildUi()
{
    ...
    wnd = gui->createWidgetReal<WN>("Kenshi_WindowCX", 0.70f, 0.10f, 0.28f, 0.86f,
    ...
    optA = Mk(c, 0.02f, 0.805f, 0.96f, 0.048f, "PCO0", NULL, OnOpt);
    optF = Mk(c, 0.02f, 0.858f, 0.96f, 0.048f, "PCO1", NULL, OnOpt);

    langLabel = c->createWidgetReal<TXB>("Kenshi_TextboxStandardText", 0.02f, 0.911f, 0.30f, 0.048f,
    ...
    optL = Mk(c, 0.34f, 0.911f, 0.64f, 0.048f, "PCO2", NULL, OnLang);
    SyncLangBtn();

    langWarn = c->createWidgetReal<TXB>("Kenshi_TextboxStandardText", 0.02f, 0.964f, 0.96f, 0.030f,
                                         AL::Default, "PCLangWarn");
    langWarn->setTextAlign(AL::Center);
    langWarn->setTextColour(C_WARN);
    langWarn->setNeedToolTip(true);
    langWarn->eventToolTip += DG(OnFontWarnTip);
    langWarn->setVisible(false);
