...
/* de_DE */ {
    ...
    "PlayableConfigurable  (%d/%d an)", "%s   (%d/%d an)", "[ AN ]  ", "[ aus ]  ", "  (Tier)",
...
/* fr_FR */ {
    ...
    "PlayableConfigurable  (%d/%d actives)", "%s   (%d/%d actives)", "[ ON ]  ", "[ off ]  ", "  (animal)",
...
/* ja_JP */ {
    ...
    "PlayableConfigurable  (%d/%d " "\xE6\x9C\x89\xE5\x8A\xB9" ")", "%s   (%d/%d " "\xE6\x9C\x89\xE5\x8A\xB9" ")", "[ " "\xE6\x9C\x89\xE5\x8A\xB9" " ]  ", "[ " "\xE7\x84\xA1\xE5\x8A\xB9" " ]  ", "  (" "\xE5\x8B\x95\xE7\x89\xA9" ")",
...
/* ko_KR */ {
    ...
    "PlayableConfigurable  (%d/%d " "\xEC\xBC\x9C\xEC\xA7\x90" ")", "%s   (%d/%d " "\xEC\xBC\x9C\xEC\xA7\x90" ")", "[ " "\xEC\xBC\x9C\xEC\xA7\x90" " ]  ", "[ " "\xEA\xBA\xBC\xEC\xA7\x90" " ]  ", "  (" "\xEB\x8F\x99\xEB\xAC\xBC" ")",
...
/* pt_BR */ {
    ...
    "PlayableConfigurable  (%d/%d ativas)", "%s   (%d/%d ativas)", "[ ON ]  ", "[ off ]  ", "  (animal)",
...
/* uk_UA */ {
    ...
    "PlayableConfigurable  (%d/%d " "\xD1\x83\xD0\xB2\xD1\x96\xD0\xBC\xD0\xBA" ")", "%s   (%d/%d " "\xD1\x83\xD0\xB2\xD1\x96\xD0\xBC\xD0\xBA" ")", "[ " "\xD0\xA3\xD0\x92\xD0\x86\xD0\x9C\xD0\x9A" " ]  ", "[ " "\xD0\xB2\xD0\xB8\xD0\xBC\xD0\xBA" " ]  ", "  (" "\xD1\x82\xD0\xB2\xD0\xB0\xD1\x80\xD0\xB8\xD0\xBD\xD0\xB0" ")",
...
/* pl_PL */ {
    ...
    "PlayableConfigurable  (%d/%d w" "\xC5\x82" ".)", "%s   (%d/%d w" "\xC5\x82" ".)", "[ W" "\xC5\x81" " ]  ", "[ wy" "\xC5\x82" " ]  ", "  (zwierz" "\xC4\x99" ")",
...
/* zh_TW */ {
    ...
    "PlayableConfigurable  (%d/%d " "\xE5\xB7\xB2\xE5\x95\x9F\xE7\x94\xA8" ")", "%s   (%d/%d " "\xE5\xB7\xB2\xE5\x95\x9F\xE7\x94\xA8" ")", "[ " "\xE9\x96\x8B" " ]  ", "[ " "\xE9\x97\x9C" " ]  ", "  (" "\xE5\x8B\x95\xE7\x89\xA9" ")",
...
const char* const LANG_FULL[L_COUNT] = {
    ...
    "Polish | Polski",
    "Chinese (Traditional) | " "\xE7\xB9\x81\xE9\xAB\x94\xE4\xB8\xAD\xE6\x96\x87"
};
const unsigned LANG_TESTCP[L_COUNT] = {
    'E', 0x0420, 0x00F1, 0x4E2D, 0x00E4, 0x00E7, 0x65E5, 0xD55C, 0x00EA, 0x0456, 0x0142, 0x8A9E
};
...
{
    for (int i = 0; i < L_COUNT; i++) if (code == LANG_CODE[i]) return i;
    for (int i = 0; i < L_COUNT; i++) if (code.compare(0, 3, LANG_CODE[i], 3) == 0) return i;
    return -1;
}
